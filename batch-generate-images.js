...
// Generates Replicate images for all migrated legacy recipes
// Run: REPLICATE_API_TOKEN=your_token node batch-generate-images.js
...
const RECIPES = [
  ...
  { slug: 'bacon-egg-cheese-breakfast-wrap', prompt: 'Professional food photography of Bacon, Egg, and Cheese Breakfast Wrap, warm golden lighting, shallow depth of field, rustic wooden table, beautifully plated, vibrant and appetizing, restaurant quality' },
...
async function main() {
  ...
  for (const recipe of RECIPES) {
    ...
    process.stdout.write(`Generating ${recipe.slug}\n`);
    try {
